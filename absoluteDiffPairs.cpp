...
1.first we have to find the absolute difference of pair of array elements, 
in reversed order which is having the maximum difference value.

for eg.,

in the below example 1
89 and 100 -> reversed=>  98 and 001 => difference = 97
this turns out to be maximum.
