/*Q:Implement an algorithm REVERSECQ that will reverse all the elements in a circular queue
maintained using linked list.
NOTE: You need to reverse the circular linked list by changing the links between the nodes */
